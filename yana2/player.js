...
function setButtons() {
  ...
  document.getElementsByClassName("prev-btn default-prev-btn")[0].setAttribute( "id", "backButtonYana" );
  
  document.getElementsByClassName("popover-title")[0].firstElementChild.id =  "x-btn-yana";
  document.getElementById("x-btn-yana").setAttribute("onchange", "closeYana");
  document.getElementById("x-btn-yana").addEventListener('click',closeYana);
